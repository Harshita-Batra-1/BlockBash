...
import { BlockBash_backend } from '../../../declarations/BlockBash_backend/index';
...
export default function UserPost() {
  ...
  const fetchComments = useCallback(async () => {
    try {
      const commentsResult = await BlockBash_backend.getAllComments();
  ...
  const handlePostComment = async (e) => {
    ...
    try {
      const userActions = []; 
      const commentsResult = await BlockBash_backend.createComment({
        userEmail: userEmail,
